...
{
	public EndNode(int nodeID, Vector2 position, float width, float height, GUIStyle nodeStyle, GUIStyle selectedStyle, GUIStyle inPointStyle, GUIStyle outPointStyle, 
		...
		OnClickRemoveNode, OnClickInPoint, OnClickOutPoint, totalInPoints, totalOutPoints)
	{
		...
		this.nodeID = nodeID;
		this.nodeInfo = new NodeInfo (nodeID, position, width, height, 3, totalInPoints, totalOutPoints);
	}
}
